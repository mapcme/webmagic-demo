 ...
 */
public class SpiderFileCacheQueueScheduler extends DuplicateRemovedScheduler implements MonitorableScheduler,Closeable {
    ...
    public SpiderFileCacheQueueScheduler(String filePath) {
